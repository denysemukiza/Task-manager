...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(backpack_view('layouts.' . (backpack_theme_config('layout') ?? 'vertical')), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\OneDrive\Task-manager\TaskManager\vendor/backpack/theme-tabler/resources/views/blank.blade.php ENDPATH**/ ?>