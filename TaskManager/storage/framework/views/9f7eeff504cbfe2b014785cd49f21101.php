  ...
  50% {
    border-color: transparent;
      ...
      .calendar-container {
        ...
        background-image: url('<?php echo e(asset('images/calebg.png')); ?>');
        padding: 20px;
        border-radius: 10px;
...
<?php $__env->startPush('after_styles'); ?>
  <?php Basset::basset('https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.6.0/styles/base16/dracula.min.css'); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startPush('after_scripts'); ?>
  <?php Basset::basset('https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.6.0/highlight.min.js'); ?>
  <script>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\user\OneDrive\Task-manager\TaskManager\vendor\backpack\crud\src\resources\views\ui/inc/getting_started.blade.php ENDPATH**/ ?>